#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-hvac-thermo
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Pure domain-driven Python library modeling HVAC vapor-compression refrigeration cycles, psychrometric moist-air properties (ASHRAE formulations), and electrical fault modes. 100% branch test coverage with zero mocks.")

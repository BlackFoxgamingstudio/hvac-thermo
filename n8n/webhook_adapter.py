#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-hvac-thermo
Listens on port 8782 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8782), WebhookHandler)
    print(f"[Sovereign Hvac Thermo] Webhook Adapter listening on http://0.0.0.0:8782")
